		...
		$.post(
			...
			function( response ) {
				...
				if ( response.success ) {
					...
					$( '.treasherlocked' ).html( '<p class="email">You have successfully registered a Treasherlocked account. Verify your email address to login using the username and password you entered.</p>' );
					processing = false;
				} else {
