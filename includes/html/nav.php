					...
					<li<?php echo IsActive( $page, HOW_TO_PLAY ); 	?>><a data-scroll href="<?php echo SITE_URL; ?>howtoplay.php/">How to Play</a></li>
					<li<?php echo IsActive( $page, RULES ); 		?>><a data-scroll href="<?php echo SITE_URL; ?>rules.php/">Rules</a></li>
					
					<?php if ( isset( $_SESSION['logged_in'] )){ ?>
					<li<?php echo IsActive( $page, LEADERBOARD ); 	?>><a data-scroll href="<?php echo SITE_URL; ?>leaderboard.php/">Leaderboard</a></li>
					<?php } ?>
