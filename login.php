				...
				<div class="social">
					...
					<div class="treasherlocked no-display">
						...
						<form id="login">
							...
							<div class="row">
								<p class="error spaced" id="submit_error">Invalid combination! Make sure you have verified your email address. A verification link has been mailed to you. Don't forget to check SPAM folder.</p>
