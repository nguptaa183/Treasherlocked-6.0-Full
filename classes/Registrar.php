			...
			$message = '<!DOCTYPE HTML>'. 
				...
				'<div id="outer" style="width: 80%;margin: 0 auto;margin-top: 10px;">'.  
				   '<div id="inner" style="width: 78%; margin: 0 auto; font-family: Calibri, Open Sans,Arial,sans-serif;font-size: 13px;font-weight: normal;line-height: 1.4em;color: #5f6061; margin-top: 10px;">'. 
					   ...
					   '<p><a href="http://treasherlocked.com/forgot-password/reset/?id=' . $id . '&auth_code=' . $auth_code . '">http://treasherlocked.com/forgot-password/reset/?id=' . $id .'&auth_code=' . $auth_code . '</a></p>'. 
					   '<p>Please contact us via <a href="https://www.facebook.com/Treasherlocked">Facebook</a> or drop us a mail at <a href="mailto:msclub.nitr@gmail.com">msclub.nitr@gmail.com</a> on persistence of any problem.</p>'.  
