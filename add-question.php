		...
		<div class="container">
			<div class="row">
				<?php
					...
					{
						echo "<p>Question Updated Successfully.</p><br />
						<a href=\"". $_SERVER["PHP_SELF"] . "\" class=\"btn btn-primary\">Add Another Question</a>";
					}
					else if(isset($error))
					{
						echo $error . 
						"<a href=\"". $_SERVER["PHP_SELF"] . "\" class=\"btn btn-primary\">Try Again</a>";	
					}
				?>
			</div>
				...
				<div class="row">
					<form id="new-question" action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="post" class="form-horizontal" enctype="multipart/form-data">
						<div class="col-md-9">
							...
							<div class="form-group">
								<div class="col-md-11">
									<textarea name="html" id="html required" placeholder="Question HTML"></textarea>
							...
							<div class="form-group">
								<div class="col-md-11">
									<textarea name="explanation" id="explanation" placeholder="Add Explanation"></textarea>
									<script type="text/javascript">
